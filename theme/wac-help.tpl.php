...
<p>The line chart form is much like the bar chart form and has special fields for X Axis, Y Axis, Alternate Data Field and Value Format. The X Axis field is anticipated to be ordinal. Typically in a line chart the X Axis data fields are some units of time. The Y Axis field is anticipated to be linear. The Alt field is used to store alternate data for each intersection of the x and y axes. These fields should contain the matching header label or JSON object key for their column or property in the data.</p>
<p>The Value Format field works identically to the bar chart field.</p>
<h3>Pie Charts</h3>
...
<h2 id="data">Data: Charting Successfully</h2>
